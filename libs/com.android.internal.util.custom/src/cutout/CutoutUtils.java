...
public class CutoutUtils {
                ...
                context.getResources()
                        .getBoolean(
                                org.lineageos.platform.internal.R.bool
                                        .config_physicalDisplayCutout);
        if (!ignoreCutoutMasked && hasCutout) {
            return !context.getResources()
                    .getBoolean(com.android.internal.R.bool.config_maskMainBuiltInDisplayCutout);
        }
        return hasCutout;
    }
    ...
    public static boolean hasCenteredCutout(Context context, boolean ignoreCutoutMasked) {
        ...
        boolean hasCenteredCutout =
                context.getResources()
                        .getBoolean(
                                org.lineageos.platform.internal.R.bool
                                        .config_physicalDisplayCutoutCentered);
